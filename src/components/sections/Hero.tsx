...
export default function Hero() {
  return (
    <div className="min-h-screen box-border flex flex-col justify-center">
      <div className="px-5 sm:px-8 md:px-12 py-12">
        ...
        <motion.div
          ...
          className="hidden md:flex border-t-2 border-black items-center justify-between gap-5 pt-7 pb-0 px-1 flex-wrap"
        >
        ...
        <div className="md:hidden border-t-2 border-black pt-5 pb-0 px-1 text-center">
