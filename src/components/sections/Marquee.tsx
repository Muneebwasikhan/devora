    ...
    >
      <div className="skew-y-2 py-7">
        <div className="flex w-max animate-marquee">
          <span className="font-display uppercase text-[10vw] tracking-[-0.03em] text-orange whitespace-nowrap pr-12">
        ...
        <div className="hidden md:flex w-max animate-marquee-rev mt-2">
          <span className="font-display uppercase text-[10vw] tracking-[-0.03em] text-white/80 whitespace-nowrap pr-12">
